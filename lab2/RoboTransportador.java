class RoboTransportador extends RoboTerrestre{
    ...
    private RoboTransportador(String nome, int posicaoX, int posicaoY, int velocidadeMax, String area_atuacao){
        super(nome, posicaoX, posicaoY, velocidadeMax);
        this.area_atuacao = area_atuacao;
    }
    private void mover(int delta_x, int delta_y, int velocidade, String area_da_entrega){
